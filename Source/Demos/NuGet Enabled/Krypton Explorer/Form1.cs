...
namespace KryptonExplorer
{
    public partial class Form1 : KryptonForm
    {
        ...
        {
            Process.Start(@"https://www.somsubhra.com/github-release-stats/?username=Wagnerp&repository=Krypton-NET-5.461");
        }
        ...
        {
            Process.Start("https://www.nuget.org/packages/KryptonToolkitSuite5461/");
        }

        private void KbtnKryptonExtendedToolkitPackage_Click(object sender, EventArgs e)
        {
            Process.Start("https://www.nuget.org/packages/KryptonExtendedToolkit5461/");
        }

        private void KbtnKryptonDemoApplicationPackage_Click(object sender, EventArgs e)
        {
            Process.Start("https://www.nuget.org/packages/KryptonToolkitSuite5461Demos/");
        }
        ...
        {
            Process.Start("https://wagnerp.github.io/Krypton-NET-5.461/Help/Output/index.html");
        }

        private void kbtnChangelog_Click(object sender, EventArgs e)
        {
            Process.Start("https://wagnerp.github.io/Krypton-NET-5.461/");
        }
